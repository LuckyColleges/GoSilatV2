...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2026 at 04:00 PM
...
INSERT INTO `athletes` (`id`, `full_name`, `birth_date`, `gender`, `nik`, `photo_athlete`, `created_at`) VALUES
(1, 'Atlet A', NULL, NULL, NULL, NULL, '2026-04-30 19:03:44'),
(2, 'Atlet B', NULL, NULL, NULL, NULL, '2026-04-30 19:03:44');
...
INSERT INTO `categories` (`id`, `tournament_id`, `name`, `min_age`, `max_age`, `cat_type_id`, `gender`, `min_weight`, `max_weight`, `created_at`) VALUES
(1, 1, 'Kelas A Putra', 0, 0, 1, NULL, NULL, NULL, '2026-04-30 19:03:44'),
(2, 1, 'Kelas B Putra', 10, 12, 1, 'male', 45.00, 50.00, '2026-05-07 13:17:25');
...
INSERT INTO `tournaments` (`id`, `name`, `location`, `start_date`, `end_date`, `status`, `created_at`) VALUES
(1, 'Test Tournament', NULL, NULL, NULL, NULL, '2026-04-30 19:03:44');
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments` (`id`),
